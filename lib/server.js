...
function initTrackedMetrics(trackedMetrics) {
  // trackedMetrics.initTime=(new Date()).getTime();
  if(trackedMetrics.global) {
    ...
    console.log("**********")
    console.log(ntrackedMetrics)
    return ntrackedMetrics;
    // return {};
      // Object.keys(trackedMetrics).map(function () {
      //
      // })
...
function Server(port, statsd, statsdRoutes,trackedMetrics) {
  ...
  // this.metrics = new Metrics.Report();
