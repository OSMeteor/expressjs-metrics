...
function initServer(port, isCluster, statsdConfig,trackedMetrics) {
  var statsd = null;
  ...
  server = new Server(port, statsd, statsdRoutes,trackedMetrics);
...
module.exports.init = function init(options) {
  ...
  if (!options.cluster && options.port) {
    initServer(options.port, false, options.statsd,options.trackedMetrics||{});
  }
